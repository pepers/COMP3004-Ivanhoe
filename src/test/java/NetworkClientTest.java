...
public class NetworkClientTest {
	...
	private static boolean serverEntered = false;
	private BufferedReader input = null; // to get user input
	private static String address;  // address of Server
	private static int port;     // port of Server
	...
	public void TestSetup() {
		...
		if (!serverEntered) {
			address = userInput("Please enter the address of the Server: ");
			String strPort = userInput("Please enter the port of the Server: ");
	...
	public void TestConnect() {
		...
		assertTrue(c2.connect(address, port));
